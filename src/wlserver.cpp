...
#include "tearing-control-unstable-v1-protocol.h"
...
static const struct zwp_surface_tearing_control_v1_interface surface_tearing_control_impl {
...
static void gamescope_tearing_get_tearing_control( struct wl_client *client, struct wl_resource *resource, uint32_t id, struct wl_resource *surface_resource )
{
	...
	struct wl_resource *surface_tearing_control_resource
		= wl_resource_create( client, &zwp_surface_tearing_control_v1_interface, wl_resource_get_version( resource ), id );
...
static const struct zwp_tearing_control_v1_interface tearing_control_impl = {
...
{
	struct wl_resource *resource = wl_resource_create( client, &zwp_tearing_control_v1_interface, version, id );
...
{
	uint32_t version = 1;
	wl_global_create( wlserver.display, &zwp_tearing_control_v1_interface, version, NULL, gamescope_tearing_bind );
}
